...
RUN apt-get update && apt-get install -y build-essential libavahi-compat-libdnssd-dev libudev-dev libpam0g-dev python apt-utils curl unzip sudo wget ffmpeg fping arp-scan nano locales
#   avahi-daemon git libpcap-dev  libfontconfig gnupg2 procps
